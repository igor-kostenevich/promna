...
const ddOptions: DDOption[] = [
  { label: 'United States', code: 'US', image: '' },
  { label: 'Germany', icon: 'checkmark', code: 'DE' },
  { label: 'Ukraine', icon: 'checkmark', code: 'UA' },
  { label: 'Japan', icon: 'checkmark', code: 'JP', disabled: true },
  { label: 'Spain', icon: 'checkmark', code: 'ES' },
];
...
<template>
  ...
  <div class="grid grid-cols-12 gap-6">
    ...
    >
      <Suspense>
        <Icon :size="48" :name="i.name" class="text-white" />
      </Suspense>
  ...
  <div class="mb-24 mt-32">
    ...
    <div class="flex flex-col gap-5">
      ...
      <Radio
        v-for="(input, idx) in inputVariants"
        :id="input.id"
        :key="input.id"
        v-model="selected"
        name="radio-example"
  ...
  <div class="mb-24 mt-32">
    ...
    <LinkButton icon-after="arrow-right" class="mb-5" to="/">{{
      String('View all')
    }}</LinkButton>
    <br />
    <LinkButton
      icon-before="arrow-right"
      external
      color="secondary"
      to="https://google.com"
  ...
  <div class="mb-24 mt-32">
    ...
    <div class="flex flex-col gap-5">
      ...
      <Checkbox id="sdadadd" v-model="isChecked3" disabled>{{
